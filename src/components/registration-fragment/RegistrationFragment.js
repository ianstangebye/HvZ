...
class RegistrationFragment extends React.Component {
    ...
    joinGame = () => {
        ...
        const url = `https://52.142.92.199/game/${this.props.game_id}/player`;
    ...
    leaveGame = () => {
        ...
        if(sid != 0 && smid != 0) { 
            const url = `https://52.142.92.199/game/${gid}/squad/${sid}/member/${smid}`;
        ...
        const url = `https://52.142.92.199/game/${gid}/player/${pid}`;
